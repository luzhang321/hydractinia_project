...
# do the taxonomic distribution based on blastn prediction 
#################################################################################################
...
setwd("/media/lu/Seagate Por/documents/201911_hydractina/2022HE_aquarium_time_series/new_analysis_with_class2_class4/11_taxonomy_profile_blastn/")
...
taxonomy_table_HE_series <- read_tsv("/media/lu/Seagate Por/documents/201911_hydractina/2022HE_aquarium_time_series/new_analysis_with_class2_class4/11_taxonomy_profile_blastn/table-with-taxonomy-blastn.tsv", skip = 1)
...
output_dir <- "/media/lu/Seagate Por/documents/201911_hydractina/2022HE_aquarium_time_series/new_analysis_with_class2_class4/11_taxonomy_profile_blastn/"
...
write_tsv(HE_series_average, paste0(output_dir, "HE_series_average_count_table_blastn.tsv"))
